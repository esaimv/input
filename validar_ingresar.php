<?php
  ...
  $_SESSION['carnet'] = $carnets;
  echo "<SCRIPT type='text/javascript'>window.open('validar_ingresar2.php','','width=600,height=400,left=50,top=50,toolbar=yes');</script>"

  //header("Location: validar_ingresar2.php");
?>
